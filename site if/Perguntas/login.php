    ...
    <nav class="nav-bar">
        <div class="logo">
            <a href="../Index/index.html">
                <img src="../Assets/logo_ifc.png" alt="Logo">
            </a>
        </div>
        <div class="nav-list">
            <ul>
                <li class="nav-item"><a href="../Sigaa/sigaa.html" class="btn-txt">SIGAA</a></li>
                <li class="nav-item"><a href="../Cursos/Cursos.html" class="btn-txt">AULAS</a></li>
                <li class="nav-item"><a href="../Horarios/horarios.html" class="btn-txt">HORÁRIOS</a></li>
                <li class="nav-item"><a href="../Eventos/eventos.html" class="btn-txt">EVENTOS</a></li>
                <li class="nav-item"><a
